...
float UMMC_MaxHealth::CalculateBaseMagnitude_Implementation(const FGameplayEffectSpec& Spec) const
{
	...
	//auto SourceASC = EffectContextHandle.GetOriginalInstigatorAbilitySystemComponent();
	//if (IsValid(SourceASC) && SourceASC->AbilityActorInfo.IsValid() && SourceASC->AbilityActorInfo->AvatarActor.IsValid())
	//{
	//	auto SourceAvatarActor = SourceASC->AbilityActorInfo->AvatarActor.Get();
	//	CombatInterface = Cast<ICombatInterface>(SourceAvatarActor);
	//}
